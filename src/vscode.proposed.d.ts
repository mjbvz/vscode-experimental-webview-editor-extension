...
declare module 'vscode' {
	...
	/**
	 * Defines the editing functionality of a custom webview editor. This allows the webview editor to hook into standard
	...
	interface WebviewCustomEditorEditingCapability<EditType = unknown> {
		 ...
		 *
		 * Note that is not invoked when `onDidEdit` is called as `onDidEdit` implies also updating the view to reflect the edit.
		 *
